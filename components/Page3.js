...
const Page3 = ({increment}) => {
    ...
    return(
        <div className="h-full w-full flex flex-col justify-center items-center">
            ...
            <p className="py-4">
                Where did we go for our first overnight trip outside of Tokyo?
            </p>
            <input
                value={input} 
            ...
            />{
               persistentErr?<p className="text-red-500 pb-4">Hint: it was mountainous and we went on a nice trek!</p>:<></>
           }
            <div
